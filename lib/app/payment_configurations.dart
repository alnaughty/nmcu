...
final defaultApplePayConfig =
    PaymentConfiguration.fromJsonString(_defaultApplePay);
...
const String _defaultApplePay = '''{
  "provider": "apple_pay",
  "data": {
    "merchantIdentifier": "merchant.com.nomnomapp.nomnom",
    "displayName": "Nom Nom Delivery app",
    "merchantCapabilities": ["3DS", "debit", "credit"],
    "supportedNetworks": ["amex", "visa", "discover", "masterCard","jcb"],
    "countryCode": "PH",
    "currencyCode": "USD",
...
final defaultGooglePayConfig =
    PaymentConfiguration.fromJsonString(_defaultGooglePay);
...
const String _defaultGooglePay = '''{
  "provider": "google_pay",
  "data": {
    "environment": "TEST",
    "apiVersion": 2,
    ...
    "merchantInfo": {
      "merchantName": "Nom Nom Delivery App"
    },
    "transactionInfo": {
      "countryCode": "PH",
      "currencyCode": "PHP"
